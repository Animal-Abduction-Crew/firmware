...
# Networks
networks = {}
networks["yolo"] = {"folder": "yolo",
                         "resolution": {"width": 192, "height": 128},
                         "weights": "yolo.weights"}
networks["yolo-tiny"] = {"folder": "yolo-tiny",
                        "resolution": {"width": 192, "height": 128},
                        "weights": "yolo.weights"}
networks["yolo-tiny-3l"] = {"folder": "yolo-tiny-3l",
                        "resolution": {"width": 192, "height": 128},
                        "weights": "yolo.weights"}
networks["yolo-tiny-oo"] = {"folder": "yolo-tiny-oo",
                        "resolution": {"width": 192, "height": 128},
                        "weights": "yolo.weights"}
networks["yolo-tiny-3l-oo"] = {"folder": "yolo-tiny-3l-oo",
                        "resolution": {"width": 192, "height": 128},
                        "weights": "yolo.weights"}
...
labelsPath = os.path.sep.join(["../", "data", "obj.names"])
...
weightsPath = os.path.sep.join(["../", "networks", selectedNetwork["folder"], "backup",
                                selectedNetwork["weights"]])
configPath = os.path.sep.join(
    ["../", "networks", selectedNetwork["folder"], "config.cfg"])
